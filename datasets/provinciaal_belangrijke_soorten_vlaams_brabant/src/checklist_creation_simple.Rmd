...
```{r}
taxon <- read.delim2(here::here("datasets", "provinciaal_belangrijke_soorten_vlaams_brabant", "data", "raw", "provinciaal_belangrijke_soorten_vlaams_brabant.csv"), sep = ";")
```
...
```{r}
write_csv(taxon, here::here("datasets", "provinciaal_belangrijke_soorten_vlaams_brabant", "data", "processed", "provinciaal_belangrijke_soorten_vlaams_brabant.csv"), na = "")
```
