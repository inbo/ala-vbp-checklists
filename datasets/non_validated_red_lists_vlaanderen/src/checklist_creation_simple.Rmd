...
```{r}
write_csv(vbp_list_validated_red_lists_flanders, here::here("datasets", "non_validated_red_lists_vlaanderen", "data", "processed", "vbp_non_validated_red_lists_flanders.csv"), na = "")
```
