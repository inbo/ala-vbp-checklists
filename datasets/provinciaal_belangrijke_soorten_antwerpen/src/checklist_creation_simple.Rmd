...
```{r}
taxon <- read.delim2(here::here("datasets", "provinciaal_belangrijke_soorten_antwerpen", "data", "raw", "provinciaal_belangrijke_soorten_antwerpen.csv"), sep = ";")
```
...
```{r}
write_csv(taxon, here::here("datasets", "provinciaal_belangrijke_soorten_antwerpen", "data", "processed", "provinciaal_belangrijke_soorten_antwerpen.csv"), na = "")
```
