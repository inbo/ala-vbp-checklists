---
title: "checklist_creation_prioritaire soorten Limburg"
...
```{r}
taxon <- read.delim2(here::here("datasets", "provinciaal_belangrijke_soorten_limburg", "data", "raw", "provinciaal_belangrijke_soorten_limburg2021.csv"), sep = ";")
```
...
```{r}
write_csv(taxon, here::here("datasets", "provinciaal_belangrijke_soorten_limburg", "data", "processed", "provinciaal_belangrijke_soorten_limburg2021.csv"), na = "")
```
