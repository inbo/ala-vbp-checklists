...
```{r}
taxon <- read.delim2(here::here("datasets", "provinciaal_belangrijke_soorten_west_vlaanderen", "data", "raw", "provinciaal_belangrijke_soorten_west_vlaanderen.csv"), sep = ";")
```
...
```{r}
write_csv(taxon, here::here("datasets", "provinciaal_belangrijke_soorten_west_vlaanderen", "data", "processed", "provinciaal_belangrijke_soorten_west_vlaanderen.csv"), na = "")
```
